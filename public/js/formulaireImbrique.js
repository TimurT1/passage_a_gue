    ...
    $('.ovrir').on("click", function(e) {
        ...
        if($(this).text()=="Cacher")
        {
            ...
            $(this).text("Cacher");
            $('.remove-equipement').parent().remove();
        }            
        $(this).parent().find("ul").toggle();  

        if( $(this).parent().find("ul").hasClass('procedures')){
            $collectionHolder=$('ul.procedures');
        }else if($(this).parent().find("ul").hasClass('equipements')){
            $collectionHolder=$('ul.equipements');
        }else{
            $collectionHolder='';
